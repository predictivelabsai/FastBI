...
DESCRIPTION = 'Explore governed data with SQL, reusable queries, dashboards, Plotly visualisations, and guarded text-to-SQL.'
KEYWORDS = ('FastBI', 'open source business intelligence', 'business intelligence software', 'SME business intelligence', 'Interactive dashboards', 'Saved SQL and data sources', 'Guarded AI analysis', 'FastSME', 'open source business software')
FEATURES = ('Interactive dashboards', 'Saved SQL and data sources', 'Guarded AI analysis')
SITEMAP_PATHS = ('/', '/integrations', '/developers')
